...
const type_company = ["Client","Supplier"];

function FormCompanies() {
  return (
    <form className="mt-2 mb-2 ml-2 mr-2">

      <p className="mt-4 mb-2 text-lg font-bold text-left">New Company</p>
      ...
      <select className=" mb-6 shadow-sm bg-neutral-100 border-gray-300 text-black text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light">
      <option value="">Select a type</option>
        {type_company.map((type, index_) => (
          <option key={index_} value={type}>
            {type}
          </option>
        ))}
      </select>
